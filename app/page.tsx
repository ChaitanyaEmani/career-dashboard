  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-5 sm:pt-10 pb-20 sm:pb-6 px-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <Header
          userName="Morning, Ankit"
          text="Welcome back! Here's your career development overview."
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="col-span-2 flex flex-col gap-6">
            ...
            {/* Learning Analytics */}
            <div className="flex flex-col gap-4 border bg-white p-5">
              <ChartCard
          ...
          <div className="col-span-1 flex flex-col bg-white border py-3.5 px-4 rounded-lg">
            ...
            <p className="text-center font-medium text-green-900 my-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white h-full border p-5 flex flex-col gap-5 rounded-lg">
            <ChartCard title="Wellbeing Analytics" viewAllText="View All" />
            <WellbeingAnalytics
              data={[
